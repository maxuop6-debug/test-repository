...
function customStrategy(data, index, breakPointsParam, ichimokuParam, trendLinesParam, refineEntryPrice) {
  ...
  const __prevIchimoku = globalThis.__state_S4_INVERSE_LadLine_BufOn.__lastIchimokuIndex === index - 1 ? globalThis.__state_S4_INVERSE_LadLine_BufOn.__lastIchimoku : null;
  globalThis.__state_S4_INVERSE_LadLine_BufOn.__lastIchimoku = ichimokuParam ? { ...ichimokuParam } : null;
  globalThis.__state_S4_INVERSE_LadLine_BufOn.__lastIchimokuIndex = index;
