...
function customStrategy(data, index, breakPointsParam, ichimokuParam, trendLinesParam, refineEntryPrice) {
  ...
  const __prevIchimoku = globalThis.__state_B4Ic14_30_57_Chk_LadLine_BufOff.__lastIchimokuIndex === index - 1 ? globalThis.__state_B4Ic14_30_57_Chk_LadLine_BufOff.__lastIchimoku : null;
  globalThis.__state_B4Ic14_30_57_Chk_LadLine_BufOff.__lastIchimoku = ichimokuParam ? { ...ichimokuParam } : null;
  globalThis.__state_B4Ic14_30_57_Chk_LadLine_BufOff.__lastIchimokuIndex = index;
  ...
  const isBullishNow = __prevIchimoku.isPriceAboveCloud &&
                        __prevIchimoku.isTenkanAboveKijun &&
                        __prevIchimoku.isChikouBullish === true;
