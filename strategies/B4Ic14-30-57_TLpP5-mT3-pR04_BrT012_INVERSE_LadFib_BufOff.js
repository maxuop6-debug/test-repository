...
function customStrategy(data, index, breakPointsParam, ichimokuParam, trendLinesParam, refineEntryPrice) {
  ...
  const __prevIchimoku = globalThis.__state_S4_INVERSE_LadFib_BufOff.__lastIchimokuIndex === index - 1 ? globalThis.__state_S4_INVERSE_LadFib_BufOff.__lastIchimoku : null;
  globalThis.__state_S4_INVERSE_LadFib_BufOff.__lastIchimoku = ichimokuParam ? { ...ichimokuParam } : null;
  globalThis.__state_S4_INVERSE_LadFib_BufOff.__lastIchimokuIndex = index;
